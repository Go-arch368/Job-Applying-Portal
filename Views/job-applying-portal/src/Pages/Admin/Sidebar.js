...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <nav className="fixed left-0 top-0 h-screen w-64 bg-gray-900 text-white shadow-lg flex flex-col p-6 transition-all duration-300">
      ...
      {/* Menu Items */}
      <ul className="flex flex-col gap-2 flex-grow p-0 m-0 list-none"> {/* Reset padding, margin, and list style */}
        {menuItems.map((item) => (
          <li
            key={item.id}
            ...
            style={{ marginLeft: 0 }} // Explicitly reset margin-left
          >
      ...
      <div className="border-t border-gray-700 pt-4">
        <button
          ...
          className="flex items-center justify-center p-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition duration-300 w-full"
        >
