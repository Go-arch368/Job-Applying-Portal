...
import { getAll,displayCandidates } from "../../redux/slices/jobFairSlice";
...
export default function RegisteredCandidates() {
    ...
    const { data, allCandidates } = useSelector((state) => state.jobFair);
    console.log(data);
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            ...
            {selectedJobFair && allCandidates?.length > 0 && (
                <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {allCandidates.map((ele) => (
                            ...
                            >
                                <p className="font-semibold text-blue-600">{ele.email}</p>
